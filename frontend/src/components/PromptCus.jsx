...
export default function PromptCus({ promptCus, setPromtCus }) {
    ...
    const styles = ["none", "Realistic", "Photorealistic", "Cartoon", "Anime", "Pixel Art", "Sketch / Pencil", "Watercolor", "Oil Painting", "Digital Painting", "Cyberpunk", "Steampunk", "Noir", "Vaporwave", "Surreal", "Minimalist", "Vintage / Retro", "Fantasy", "Sci-fi"];
    ...
    return (
        <>
            <div className="w-[200px] lg:w-[250px] relative">
                <p className="text-gray-300 hover:text-white italic text-sm transition-all duration-500 text-left inline-block">mood</p>
                <button className="rounded-sm text-gray-300 w-full h-8 border border-gray-300/30 hover:border-white hover:text-white flex items-center transition-all duration-500"
            ...
            <div className="w-[200px] lg:w-[250px] relative">
                <p className="text-gray-300 hover:text-white italic text-sm transition-all duration-500 text-left inline-block">style</p>
                <button className="rounded-sm text-gray-300 w-full h-8 border border-gray-300/30 hover:border-white hover:text-white flex items-center transition-all duration-500"
                    onClick={() => {
            ...
            <div className="w-[200px] lg:w-[250px] relative">
                <p className="text-gray-300 hover:text-white italic text-sm transition-all duration-500 text-left inline-block">camera angle</p>
                <button className="rounded-sm text-gray-300 w-full h-8 border border-gray-300/30 hover:border-white hover:text-white flex items-center transition-all duration-500"
